...
-- stylua: ignore start
local KEYWORD_FN    = "@keyword.function.lua"
local KEYWORD       = "@keyword.lua"
local KEYWORD_OP    = "@keyword.operator.lua"
local TYPE          = "@type.lua"
local TYPE_BUILTIN  = "@type.builtin.lua"
local FUNC          = "@function.lua"
local VAR           = "@variable.lua"
local VAR_MEMBER    = "@variable.member.lua"
local VAR_PARAM     = "@variable.parameter.lua"
local VAR_BUILTIN   = "@variable.builtin.lua"
local STRING        = "@string.lua"
local NUMBER        = "@number.lua"
local BOOLEAN       = "@boolean.lua"
local CONST_BUILTIN = "@constant.builtin.lua"
local PUNCT_BRACKET = "@punctuation.bracket.lua"
local PUNCT_DELIM   = "@punctuation.delimiter.lua"
local PUNCT_SPECIAL = "@punctuation.special.lua"
local OPERATOR      = "@operator.lua"
-- stylua: ignore end
