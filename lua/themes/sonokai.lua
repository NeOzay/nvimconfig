...
M.polish_hl = {
  ...
  defaults = {
    ...
    LineNr = { fg = M.base_30.grey_fg, bg = M.base_30.one_bg }, -- editorLineNumber.foreground + darker gutter
  ...
  telescope = {
    TelescopeSelection = { bg = "#3b3e48", fg = M.base_30.white },
    TelescopeMatching = { fg = M.base_30.green }, -- highlightForeground
    TelescopeBorder = { fg = "#414550", bg = M.base_30.black },
    TelescopePromptBorder = { fg = "#414550", bg = M.base_30.black },
    TelescopeResultsBorder = { fg = "#414550", bg = M.base_30.black },
    TelescopePreviewBorder = { fg = "#414550", bg = M.base_30.black },
    TelescopePromptPrefix = { fg = M.base_30.green },
  },
